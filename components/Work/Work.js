...
const Work = ({ isDesktop }) => {
  ...
  const tabItems = useMemo(
    () => [
      {
        title: "Subcription Website",
        value: "Subcription Website",
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.Sub}
          />
        ),
      },
      {
        title: "One-Time Payment Solution",
        value: "One-Time Payment Solution",
        content: (
          <StickyScroll
            isDesktop={isDesktop}
      ...
      },
      {
        ...
        value: "Custom Website Solutions",
        content: (
          <StickyScroll
            isDesktop={isDesktop}
