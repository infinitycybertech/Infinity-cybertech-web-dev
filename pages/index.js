...
import DesktopCanvas from "@/components/canvas/Desktops";
      ...
      {isLoading ? (
        ...
        <>
          ...
          <main className="flex flex-col">
            <div
              role="img"
              className="text-gray-light-1 opacity-10 sm:text-7xl xs:text-6xl inline-block -z-10 absolute rotate-90 right-0 md:top-52 xs:top-96"
            >
              WEB DEV
            </div>
